        ...
        {selectedStation && (
          <div className="ml-auto flex items-end">
            <Dialog open={openPompiste} onOpenChange={setOpenPompiste}>
              <DialogTrigger className="inline-flex items-center justify-center rounded-md bg-[#0369A1] hover:bg-blue-700 text-white text-sm font-medium px-3 py-1.5 transition-colors">
